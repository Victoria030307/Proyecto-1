 ...
 * @author victo
 */
// package proyecto1_zarbo_hernandez_abad; // Descomentar si usas paquete
// Importaciones eliminadas: Stack, List, ArrayList, Set, HashSet
...
public class Grafo {
    ...
    public Grafo(int num){
        this.capacidad = (num > 0) ? num : CAPACIDAD_INICIAL;
